...
function Detail({ id, title }) {
  ...
  const maxLen = 500 + dataDetail?.description.substring(500).indexOf(" ");
          ...
          <div style={{ display: "flex", padding: " 20px 0px" }}>
            <div style={{ flex: "1" }}>
              ...
              <div ref={descriptionRef}>
                <StoryDescription description={dataDetail?.description} maxLength={maxLen} onToggle={handleDescriptionResize} />
              </div>
            </div>
