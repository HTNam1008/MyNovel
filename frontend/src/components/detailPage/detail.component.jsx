              ...
              <ul style={{ paddingLeft: "0rem" }}>
                ...
                >
                  <span
                    ...
                    style={{ color: theme === "dark" ? "#1D3557" : "#DDF2FD" }}
                  >
                    Tác giả
                  </span>
                  <span
                ...
                >
                  <Button
                    ...
                    disabled={dataChapters.length === 0}
                  ...
                  >
                    ...
                    >
                      <img
                        src={`${process.env.PUBLIC_URL}/images/read_book.png`}
                        style={{
                          marginRight: "8px",
                          width: "20px",
                          height: "20px",
            ...
            <div style={{ flex: "1" }}>
              ...
              <div ref={descriptionRef}>
                <StoryDescription
                  ...
                  maxLength={500}
                  onToggle={handleDescriptionResize}
                />
              </div>
            </div>
              ...
              >
                {dataChapters.length !== 0 ? (
                  dataChapters.map((chapter, index) => (
                    <li
                      ...
                      onClick={() =>
                        handleRead(
                          ...
                          _title,
                          vietnameseToSlug(
                            getSubstringBeforeColon(chapter.title)
                          )
                        )
                      }
                      style={{
                    ...
                    >
                      {chapter._title ? chapter._title : chapter.title}
                    </li>
                  ))
                ) : (
